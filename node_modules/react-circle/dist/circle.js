...
var Circle = (function (_super) {
    ...
    Circle.prototype.render = function () {
        var text = this.text;
        var _a = this.props, progress = _a.progress, size = _a.size, bgColor = _a.bgColor, progressColor = _a.progressColor, lineWidth = _a.lineWidth, animate = _a.animate, roundedStroke = _a.roundedStroke, responsive = _a.responsive;
        var strokeDashoffset = getOffset(progress);
        var transition = animate ? 'stroke-dashoffset 1s ease-out' : null;
