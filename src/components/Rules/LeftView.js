      ...
      <ul className=" text-left list-unstyled ">
        ...
        <li className="ml-1 mt-4">
          <div className="checkbox checkbox-info">
            ...
            </label>  <i className="fa fa-info-circle" data-toggle="tooltip" data-delay='{"show":"0", "hide":"0"}' title="Delay time between subsequent notification'll not be constant." > </i>
          </div>
        </li>
        <li className="ml-1 mt-4">
          <div className="checkbox checkbox-info">
