      ...
      <Grid fluid="fluid">
            ...
            <div className="card card-plain headtxt">
              <div className="header">
                ...
                <div className="backBtn">
                  <a href="javascript:;" onClick={this.handleBackBtn.bind(this)}>
        ...
        <Row>
          <Col md={4}>
            <Row>
              <Col md={6}>
                <Cards cardIcon="far fa-bell" cardText={this.props.data.name}/>
              </Col>
              <Col md={6}>
                <Cards cardIcon="fas fa-envelope" cardText={this.props.data.email}/>
              </Col>
            </Row>
            <Row>
              <Col md={12}>
                <Cards cardIcon="fas fa-globe" cardText={this.props.data.url}/>
              </Col>
            </Row>
          </Col>
          <Col md={8}>
