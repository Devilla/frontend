    ...
    return (<div className="content fill ">
      <Grid fluid="fluid">
        <Row className="inlineclr">
          <Col md={30}>
            <CardHeader title="Billing" content={<div className = "Billing-container " > <Row>
                ...
                <div className="col-md-2">
                  <div className="profile-over-button">
                    <Button onClick={() => browserHistory.push('/Upgrade')} bsStyle="info" pullRight="pullRight" fill="fill" type="button" icon="cloud-upload" disabled={false}>Upgrade
                    </Button>
                  </div>
                  <div className="profile-over-button">
                    <Button onClick={() => browserHistory.push('/Billing')} bsStyle="info" pullRight="pullRight" fill="fill" type="button" icon="usd" disabled={false}>Billing /Payment Details
                    </Button>
                  </div>
                </div>
              </Row>
              ...
              <Row>
                ...
                <div className="col-md-2">
                  Payment Method:
                  <Button type="info" pullRight="pullRight" icon="credit-card" disabled={true}></Button>
                </div>

                <div className="col-md-2">
                  <FormGroup >
                    <FormControl type="text" value="" placeholder="VISA 4*** **** **** 2006" id="Visanumber" onChange={(e) => this.handleStateChange(e)}/>
                  </FormGroup>
                </div>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      <tr>
                        <td id="noBorder">
                          <Button onClick={() => {}} pullRight="pullRight" icon="file" disabled={false}></Button>
                        </td>
                        <td id="noBorder">
                          <Button onClick={() => {}} icon="cloud-download" disabled={false}></Button>
                  ...
                  <tr>
                    ...
                    <td>
                      <tr>
                        <td id="noBorder">
                          <Button onClick={() => {}} icon="file" disabled={false}></Button>
                        </td>
                        <td id="noBorder">
                          <Button onClick={() => {}} icon="cloud-download" disabled={false}></Button>
