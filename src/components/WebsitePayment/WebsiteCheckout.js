...
const WebsiteCheckout = ({ selectedPlan, clearSelectedPlan, coupon }) =>  {
  (function() {
            ...
            <div className="row give-center-align">
              ...
              <div className="col-md-4 socio-link">
                ...
                <div className="mt--2 lead">
                  { /\b(Startups)\b/m.test(selectedPlan.name) ? (
                  ...
                  { /\b(Enterprise)\b/m.test(selectedPlan.name) ? (
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" className="formss">
                      <input type="hidden" name="cmd" value="_s-xclick" />
                  ...
                  {  /\b(Small)\b/m.test(selectedPlan.name) ? (
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" className="formss">
                      <input type="hidden" name="cmd" value="_s-xclick" />
                  ...
                  {  /\b(Advanced)\b/m.test(selectedPlan.name) ? (
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" className="formss">
                      <input type="hidden" name="cmd" value="_s-xclick" />
