    ...
    return (
      <div className="websitehome-container">
        <div className="main-container">
          <section className="pl-5 pt-0 text-center row" data-overlay="0">
            ...
            <div className="container text-left col-md-5 pr-0 ml-0 pt-4">
              
              <img alt="homescreen" src={sideScreen_1} className="sidescreen mb-1" style={{height: '400px'}} />
