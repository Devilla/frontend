        ...
        <Grid fluid>
          <div className="tabscontent">
            ...
            <div className="float-right">
              <button type="button" className="btn btn-primary  waves-effect number ml-2 pl-4 pr-3 displaybtn-next" onClick={this.handleNextState}>Next<i className="icon-arrow-right pl-2"></i> </button>
            </div>
