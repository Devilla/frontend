            ...
            <Row className="campaign-type-content">
              <Col md={5} className="left-content pr-0 mr-0">
                <Row className="campaign-type-button ml-5">
                  <button className="btn btn-normal-campaign" onClick={() => handleCampaignType('default')}>Normal Campaign</button>
                </Row>
              ...
              <Col md={5} className="right-content pl-0 ml-0">
                <Row className="campaign-type-button mr-5">
                  <button className="btn btn-product-specific" onClick={() => handleCampaignType('page')}>Page Specifc Campaign</button>
                </Row>
