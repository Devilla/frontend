...
const InstallPixel = ({
  ...
  return (
    <div className="install-pixel">
      <label className="text-muted">Copy your unique script & paste it in the Header of your Website. Add this
        to every page where you want to track, measure and show notifications.</label>
