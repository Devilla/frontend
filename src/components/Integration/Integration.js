        ...
        <Row className="justify-content-around mb-5">
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">Facebook</h4>
          ...
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">Zendesk</h4>
          ...
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">Google</h4>
              <span className="text-muted ">View Details&nbsp; <i className="fi-open"></i></span>
            </div>
          </Col>
        </Row>
        <Row className="justify-content-around mb-5">  
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">TrustPilot</h4>
              <span className="text-muted ">View Details&nbsp; <i className="fi-open"></i></span>
            </div>
          </Col>
          <Col md={3}  className="bx-shadow">
          ...
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">G2Crowd</h4>
              <span className="text-muted ">View Details&nbsp; <i className="fi-open"></i></span>
            </div>
          </Col> 
        </Row>
        <Row className="justify-content-around mb-5">
          ...
          <Col md={3}  className="bx-shadow">
            <div className="card-box tilebox-one">
              ...
              <h4 className="text-muted text-uppercase mt-0 i-title">Yelp</h4>
              <span className="text-muted ">View Details&nbsp; <i className="fi-open"></i></span>
            </div>
          </Col>
          <Col md={3}  className="bx-shadow">
