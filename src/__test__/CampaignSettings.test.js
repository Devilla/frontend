...
describe('>>>Campaign Settings --- Snapshot',()=>{
...
describe("+++ test for the website pricing component", () => {
    let wrapper;
    beforeEach ( () => {
         wrapper = shallow(<CampaignSettings store={store}/>);
    })
    ...
    it('+++ render the DUMB component', () => {
      ...
      it('+++ contains website - container', () => {
        let wrapper = shallow(<CampaignSettings  store={store}/>);
      ...
      it('+++ contains website - button', () => {
        let wrapper = shallow(<CampaignSettings  store={store}/>);
        expect(wrapper.find('button').length).not.toBe(null);
      });
})
