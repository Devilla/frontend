...
module.exports = {
  ...
  'campaign test Influence': function (client) {
    client
      ...
      .waitForElementVisible('#settings1 > div > div > div > div:nth-child(2) > div.col-md-11 > div > input', 10000)
      ...
      .pause(5000)
      .waitForElementVisible('#settings2 > div > div > div > div:nth-child(2) > div.col-md-11 > div > input', 10000)
